...
千万不要在Google或开发者社区疯狂讨论一个新工具或新概念时，着急上手这些东西。很多时候，Google实际上是在招募小白鼠，而大伙儿更多的是只动动嘴皮子。想要真正在生产环境中使用这些东西，要等待尘埃落定，否则要做好踩很多坑的准备。比如宣传了很久的大屏幕支持、XR、CameraX、客户端AI功能等，虽然看起来很酷，但距离商业级应用还有不少距离。另外，开发资源通常只能留给大多数用户，比如虽然大屏幕设备越来越多，但相比单手持手机还差得远哩。
